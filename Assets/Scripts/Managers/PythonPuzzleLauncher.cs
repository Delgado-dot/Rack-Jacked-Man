...
public class PythonPuzzleManager : MonoBehaviour
{
    ...
    {
        string puzzleElegido = puzzles[
            UnityEngine.Random.Range(0, puzzles.Length)
        ];
    ...
    public string EjecutarPuzzle(string nombrePuzzle)
    {
        ...
        try
        {
            Diagnostics.ProcessStartInfo info =
            ...
            string rutaResultado = Path.Combine(
                rutaCarpeta,
                "resultado.txt"
            );
