...
class MenuPausa:
    OPCIONES = [("reanudar", "REANUDAR"), ("reiniciar", "REINICIAR"), ("menu", "MENU PRINCIPAL"), ("salir", "SALIR")]
    ...
    def _dibujar(self):
        ...
        pygame.draw.rect(self.pantalla, self.COLOR_BORDE, (self.panel_x, self.panel_y, self.panel_w, self.panel_h), 2, border_radius=12)
        ...
        hint = self.fuente_opcion.render("ESC: Reanudar  |  Up/Down: Navegar  |  ENTER: Seleccionar", True, (100, 130, 160))
