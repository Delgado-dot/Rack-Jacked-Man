...
Corregido:
- Mantiene el puzzle funcionando igual.
- Agrega ESC dentro del puzzle para abrir el menú de pausa.
- Si das Reanudar, vuelve al mismo puzzle sin dañar pantalla.
- Si das Reiniciar o Menú, devuelve ese resultado al main.
"""
...
class PuzzleCables(BasePuzzle):
    ...
    def _abrir_pausa_puzzle(self):
        """
        Abre el menú de pausa sin crear otro puzzle.
        Reanudar vuelve al mismo puzzle.
        Reiniciar/Menu/Salir se devuelven al main.
        """
        try:
            self._dibujar()
            pygame.display.flip()
