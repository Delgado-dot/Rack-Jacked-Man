...
class PuzzleNave(BasePuzzle):
    ...
    def _actualizar_subclase(self, dt):
        ...
        for v in self.virus:
            v["x"] -= self.vel_virus
        for b in self.balas:
            # Movimiento de la bala según su ángulo
    ...
    def _disparar(self):
        ...
        if self.game_over_disparado:
            return
        # La bala sale de la punta de la nave 
        nave_cx = self.nave["x"] + NAVE_W // 2
        nave_cy = self.nave["y"] + NAVE_H // 2
    ...
    def _dibujar_nave(self):
        ...
        # Coordenadas relativas al centro de la superficie
        ala_pts_izq = [
